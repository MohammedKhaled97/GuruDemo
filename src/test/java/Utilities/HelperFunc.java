...
public class HelperFunc extends BaseTest {
    ...
    public void WriteDataToSheet(String FileName, String SheetName, String UserID, String Pass) throws IOException {
    ...
    public void WriteIDToSheet(String FileName, String SheetName, String ID) throws IOException {
        FileInputStream fis = new FileInputStream(FileName);
        XSSFWorkbook workbook = new XSSFWorkbook(fis);
        XSSFSheet sheet = workbook.getSheet(SheetName);
